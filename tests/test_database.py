...
def test_face_embedding_repository_crud(db_session):
    ...
    # Encryption-at-rest (utils.crypto_utils) operates in pass-through mode
    # whenever ENCRYPTION_KEY is unset — which is the case in the test env.
    # Set ENCRYPTION_KEY in .env and embedding_vector will be Fernet ciphertext
    # instead of the raw bytes. See utils/crypto_utils.py.
    assert created.embedding_vector == plain_embedding
